...
train_label_path = f"{training_config.LABEL_DIR}/train/train_label.json"
...
save_trained_model_path = f"{save_trained_model_dir}/{mrcnn_config.BACKBONE}_{train_model_time}.h5"
save_history_path = f"{save_trained_model_dir}/{mrcnn_config.BACKBONE}_{train_model_time}.csv"
...
callbacks_list = [
                        ...
                        tf.keras.callbacks.ModelCheckpoint(
                            f"{save_trained_model_dir}/{mrcnn_config.BACKBONE}_{weight_type}\
                                _{training_config.TRAINABLE_LAYERS}_{train_model_time}.h5", 
                            save_best_only=True, 
